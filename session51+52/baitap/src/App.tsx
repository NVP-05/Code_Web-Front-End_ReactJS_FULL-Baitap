...
import "./css/mixins/_background-variant.css";
import "./css/mixins/_deprecate.css";
import "./css/mixins/_resize.css";
import "./css/vendor/_rfs.css";
import Elements from "./components/elements/Elements";
import Service from "./components/service/Service";

import hero_slider_1 from "./assets/images/hero-slider-1.jpg";
import hero_slider_2 from "./assets/images/hero-slider-2.jpg";
import hero_slider_3 from "./assets/images/hero-slider-3.jpg";
import hero_slider_4 from "./assets/images/hero-slider-4.jpg";
import hero_slider_5 from "./assets/images/hero-slider-5.jpg";
        ...
        <>
          ...
          <nav className="site-nav">
            <div className="container">
              <div className="site-navigation" style={{ display: "flex" }}>
