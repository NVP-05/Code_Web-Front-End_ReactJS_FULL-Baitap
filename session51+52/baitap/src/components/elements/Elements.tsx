import gal_1 from "../../assets/images/gal_1.jpg";
import gal_2 from "../../assets/images/gal_2.jpg";
import gal_3 from "../../assets/images/gal_3.jpg";
import gal_4 from "../../assets/images/gal_4.jpg";
import gal_5 from "../../assets/images/gal_5.jpg";
import gal_6 from "../../assets/images/gal_6.jpg";
                  ...
                  <div className="row gutter-v2 gallery">
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_1} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_2} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_3} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_4} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_5} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                    <div className="col-4">
                      <a
                        ...
                        data-fancybox="gal"
                      >
                        <img src={gal_6} alt="Image" className="img-fluid" />
                      </a>
                    </div>
                  </div>
                </div>{" "}
              ...
              <div className="col-lg-4">
                ...
                >
                  ...
                  <div className="owl-single owl-carousel no-nav">
                    ...
                    <div className="testimonial mx-auto">
                      <figure className="img-wrap">
                        <img src={person_3} alt="Image" className="img-fluid" />
                      </figure>
                    ...
                    <div className="testimonial mx-auto">
                      <figure className="img-wrap">
                        <img src={person_4} alt="Image" className="img-fluid" />
                      </figure>
